...
const Register = () => {
    ...
    return (
        <div className={`flex items-center justify-center min-h-screen ${theme === 'dark' ? 'bg-gray-900' : 'bg-blue-100'}`}>
...
<div className="mt-4">
  ...
  <input
    ...
    className={`w-full px-3 py-2 mt-1 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300 ${
        theme === 'dark' ? 'bg-gray-800 text-gray-200 placeholder-gray-400' : 'bg-white'
      }`}
